...
BEGIN;
  ...
  ALTER TABLE web.page_views_tmp RENAME TO web.page_views;
...
BEGIN;
  ...
  ALTER TABLE web.sessions_tmp RENAME TO web.sessions;
...
BEGIN;
  ...
  ALTER TABLE web.users_tmp RENAME TO web.users;
